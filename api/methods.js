const methods = module.exports //instancia a exportacao de metodo para uma constante, assim, sempre que chamada, retornara um modulo
const conn = require('../db') //resgata a conexao com o bd
methods.usuario = (req, res) => {
...
methods.transferencias = (req, res) => {
...
methods.transferenciasByUsuarioId = (req, res) => {
